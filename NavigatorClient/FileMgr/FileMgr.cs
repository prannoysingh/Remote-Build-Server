...
{
    // contains the location of the local repository where all the files are located
  public struct ClientEnvironment
  {
        //public static string localRoot { get; set; } = "../../../contents/";
        public static string localRoot { get; set; } = "../../../RepoStore/";
   }

    // contains the location for the server files
