...
/////////////////////////////////////////////////////////////////////
/*
 * Created openFileForWrite1 operation contract for file transfer.
 * 
 * Added references to:
 * - System.ServiceModel
...
namespace MessagePassingComm
{
    ...
    {
        public const string fileStorage = "../../../RepoStore";
        public const string childStorage = "../../../ChildStorage";
        public const string testStorage = "../../../TestHarnessStorage";
    ...
    {
        public const string fileStorage = "../../../ChildStorage";
        public const string testStorage = "../../../TestHarnessStorage";
        public const string RepoStorage = "../../../RepoStore";
        public static string baseAddress { get; set; }
    }
    ...
    public interface IMessagePassingComm
    {
        ...
        [OperationContract]
        bool openFileForWrite2(string name);

        [OperationContract]
        bool openFileForWrite1(string name, string path);
