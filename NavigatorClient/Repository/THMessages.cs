...
namespace TestHarnessMessages
{
  ...
  public class TestElement  /* information about a single test */
  {
    ...
    public TestElement() {
           // "inside Test Element => information about a single test ".title();
        }
  ...
  public class TestRequest  /* a container for one or more TestElements */
  {
    ...
    public TestRequest() {
           // "insides test request => a container for one or more TestElements ".title();
        }
  ...
  public class TestResult  /* information about processing of a single test */
  {
    ...
    public TestResult() {
            "inside Test Result => information about processing of a single test ".title();
    ...
    /* a container for one or more TestResult instances */
public class TestResults 
  {
    ...
    public TestResults() {
          //  "inside Test Results => a container for one or more TestResult instances ".title();
        }
